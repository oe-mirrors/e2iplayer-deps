...
function build {
    ...
    $CROSS_COMPILE"gcc" -O2 -Werror -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE=1  $PARAMS src/*.c -o out/$PLATFORM/cmdwarp
    $CROSS_COMPILE"strip" -s out/$PLATFORM/cmdwarp
}
